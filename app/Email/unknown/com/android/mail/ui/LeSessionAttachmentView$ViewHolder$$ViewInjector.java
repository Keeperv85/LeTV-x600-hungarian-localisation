...
public class LeSessionAttachmentView$ViewHolder$$ViewInjector {
  public static void inject(Finder finder, final com.android.mail.ui.LeSessionAttachmentView.ViewHolder target, Object source) {
    View view;
    ...
    view = finder.findRequiredView(source, 2131624435, "field 'mProgressBar' and method 'onProgressBarClick'");
    ...
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          ...
          target.onProgressBarClick();
        }
      });
  }

  public static void reset(com.android.mail.ui.LeSessionAttachmentView.ViewHolder target) {
    target.mIcon = null;
    target.mName = null;
    target.mSize = null;
